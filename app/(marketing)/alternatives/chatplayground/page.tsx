...
export const metadata = constructMetadata({
  ...
  description:
    "Looking for a ChatPlayground alternative? Arco lets you compare 400+ AI models with your own OpenRouter key, no monthly subscription, and every chat stays on your Mac.",
});
